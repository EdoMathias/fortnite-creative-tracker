    ...
    return (
        <div className="overview-container">
            ...
            <div className="overview-stats-row">
                ...
                <div className="overview-tile overview-tile-stat">
                    <div className="overview-tile-icon">🗺️</div>
                    <div className="overview-tile-value">{recentMaps && recentMaps.length > 0 ? recentMaps.length : '0'}</div>
            ...
            <div className="overview-tile overview-tile-wide overview-hero-tile">
                ...
                {topMap ? (
                    <div
                        ...
                        style={{
                            backgroundImage: topMap.thumbnail ? `url(${topMap.thumbnail})` : 'none'
                        }}
                    >
                        <div className="overview-hero-content">
                            ...
                            <button className="overview-hero-launch">
                                ▶ LAUNCH MAP
                            </button>
                        </div>
                    </div>
