...
import { kHotkeys, kGameClassIds } from '../consts';
...
export const FTUEWelcomeModal: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const loadHotkeys = async () => {
      try {
        const [trackMeIngame, trackMeDesktop, scanMe, itemListIngame] = await Promise.all([
          ...
          OWHotkeys.getHotkeyText(kHotkeys.scanMe, kGameClassIds[0]),
          OWHotkeys.getHotkeyText(kHotkeys.toggleTrackedItems, kGameClassIds[0])
        ]);
        setHotkeys({ trackMeIngame, trackMeDesktop, scanMe, itemListIngame });
      } catch (error) {
        ...
        <div className="ftue-welcome-content">
          <div className="ftue-feature">
            ...
            <div className="ftue-feature">
              <div className="ftue-feature-icon">📋</div>
              <div className="ftue-feature-info">
                <h3>Tracked Items List</h3>
                <p>View a list of your tracked items in-game</p>
                <span>Show/Hide the item list in-game with: </span>
                <div className="ftue-hotkey-badge">{hotkeys.itemListIngame}</div>
              </div>
            </div>
            ...
            <div className="ftue-feature">
              ...
              <div className="ftue-feature-info">
                <h3>Scan Item</h3>
                <p>Scan items from your screen to get item details</p>
                <span>Scan items in-game with: </span>
                <div className="ftue-hotkey-badge">{hotkeys.scanMe}</div>
            </div>
          </div>
